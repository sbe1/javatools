 ...
 * for creating a single JDBC connection and persisting that connection for
 * the life of an instance of this class.
 *
...
public final class JDBC {
    ...
    public JDBC (final String connectionString) {
        try { this.con = DriverManager.getConnection(connectionString); }
